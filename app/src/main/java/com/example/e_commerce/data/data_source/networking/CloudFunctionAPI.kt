...
import com.example.e_commerce.data.models.GenericResponse
...
interface CloudFunctionAPI {
    ...
    ): retrofit2.Response<GenericResponse<RegisterResponseModel>>

    companion object {
        private const val BASE_URL = "https://us-central1-e-commerce-4676c.cloudfunctions.net/"
